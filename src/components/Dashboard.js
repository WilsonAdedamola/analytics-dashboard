...
import justin from "../assets/avatars/justin.png";
...
const Dashboard = () => {
  return (
    <div className="w-screen">
      {MobileHeader()}
      <header className="hidden grid-col lg:grid gap-5 xl:gap-8 place-items-center px-3 xl:px-5 py-5 xl:py-7 border-b max-w-[95%] ml-auto w-full">
        <div className="flex items-center justify-between w-full">
          <p className="font-semibold text-xl">Dashboard</p>
          <div className="flex items-center gap-2 rounded-full p-2 border-[#DADDDD] border bg-white">
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
        ...
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-2">
            <img src={justin} alt="Justin Bergson" />
      ...
      {MobileAside()}
      <aside className="hidden lg:flex bg-[#F7F8FA] h-screen absolute top-0 w-[5%] border-r py-7 border-[#EBECF2] items-center justify-between flex-col">
        <div className="flex flex-col gap-8 items-center justify-center">
          ...
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            <div className="flex flex-col gap-8 items-center justify-center bg-white rounded-full p-2">
              <div className="rounded-full flex items-center justify-center p-1 bg-[#34CAA5]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
                  height="18"
...
function MobileAside() {
  ...
  return (
    <aside className="lg:hidden h-screen absolute top-0 w-[14%] sm:w-[10%] flex items-center flex-col">
      <div className="flex flex-col gap- lg:gap-8 items-center w-full h-full">
        <div className="flex items-center justify-center border-r py-2 max-h-[60px] w-full border-[#EBECF2] bg-[#F7F8FA] h-full cursor-pointer">
          <img src={logo} alt="Logo" className="w-8" onClick={handleClick} />
        </div>
        <div
          className={
            !showSidebar
              ? "flex flex-col gap-4 items-center justify-between pb-5 h-full w-full border-r border-[#EBECF2] bg-[#F7F8FA]"
              : "hidden"
          }
        >
          <div className="flex flex-col items-center justify-center gap-8">
            ...
            <div className="flex flex-col gap-8 items-center justify-center bg-white rounded-full p-1">
              <div className="rounded-full flex items-center justify-center p-1 bg-[#34CAA5]">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="18"
...
function MobileHeader() {
  ...
  return (
    <header className="mobile-header-grid lg:hidden grid place-items-center px-2 border-b max-w-[86%] sm:max-w-[90%] h-[60px] ml-auto w-full">
      <p className="font-semibold text-sm place-self-start self-center">
        Dashboard
      </p>
      <div className="flex items-center gap-2 rounded-full px-2 py-1 w-full border-[#DADDDD] border bg-white">
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
        ...
        <input
          type="text"
          placeholder="Search"
          className="px-1 w-full placeholder:text-sm"
        />
      </div>
      <div className="relative w-full flex flex-col items-center">
        <img onClick={handleClick} src={justin} alt="Justin Bergson" className="cursor-pointer" />
        <div className={ showMenu ? "bg-white border rounded-2xl absolute top-11 right-3 flex flex-col gap-3 items-start justify-center w-max px-5 py-3" : "hidden"}>
          <div className="flex items-center gap-2">
            <svg
              width="18"
              height="18"
            ...
            <p className="text-xs font-medium">November 15, 2023</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            <img src={justin} alt="Justin Bergson" className="w-5" />
            <div className="flex items-start justify-center flex-col">
              <p className="text-[#26282C] text-xs">Justin Bergson</p>
              <p className="text-sm text-[#787486]">Justin@gmail.com</p>
            </div>
          </div>
        </div>
